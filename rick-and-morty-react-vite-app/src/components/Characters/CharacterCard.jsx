  ...
  return (
    <Card>
      ...
      <div className="flex flex-col items-start justify-start">
        ...
        <p className="flex justify-center items-center"><span className="font-semibold">Status:</span> <CharacterStatus status={status} /></p>
        <p><span className="font-semibold">Species:</span> {species}</p>
        {origin && <p><span className="font-semibold">Origin:</span> {origin.name}</p>}
        {location && <p><span className="font-semibold">Location:</span> {location.name}</p>}
      </div>
    </Card>
  );
}
