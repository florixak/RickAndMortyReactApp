...
const App = () => {
  ...
  return (
    <div className="overflow-x-hidden relative flex flex-col w-full h-full min-h-[100vh] pb-[5rem] gap-5 animated-background text-white bg-gradient-to-r from-slate-800 via-slate-700 to-slate-900">
      <Header />
      <Routes>
